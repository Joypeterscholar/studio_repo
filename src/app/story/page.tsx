  ...
  return (
    <div className="relative h-screen w-screen bg-background">
      ...
      <header className="absolute top-0 right-0 p-4 pt-12">
        <Button onClick={() => router.back()} variant="ghost" size="icon" className="bg-black/30 text-white hover:bg-black/50 hover:text-white">
          <X className="h-6 w-6" />
        </Button>
      </header>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom))' }}>
        <div className="flex items-center gap-2 rounded-full bg-white/90 p-2 shadow-lg backdrop-blur-sm">
          ...
          <Input 
            ...
            className="flex-1 border-none bg-transparent text-base focus-visible:ring-0 focus-visible:ring-offset-0 h-auto"
          />
          <Button size="icon" className="bg-accent text-white w-10 h-10 flex-shrink-0">

...
const VerifiedIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.03 15.43l-4.5-4.5 1.41-1.41 3.09 3.08 7.07-7.07 1.41 1.41-8.48 8.49z" fill="#4A90E2"/>
  </svg>
);
        ...
        <main className="px-4">
          <div className="grid grid-cols-3 grid-rows-2 gap-2 h-80">
            <div className="col-span-2 row-span-2 relative rounded-xl overflow-hidden">
                ...
                />
                <Button variant="secondary" className="absolute top-4 left-4 rounded-full shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm">
                <div className="flex justify-between items-center mb-1">
                    <h2 className="font-bold text-primary text-lg">I'm Looking for</h2>
                    <Pencil className="w-4 h-4 text-muted-foreground"/>
                </div>
                <p className="text-muted-foreground text-sm">
                    Serious Relationship with a man, Casual friendship, and Travel Partner that lives close by.
                </p>
            </div>
             <div className="bg-white p-4 rounded-xl shadow-sm">
                <div className="flex justify-between items-center mb-1">

...
const SpiritualIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9 10C9 8.34315 10.3431 7 12 7C13.6569 7 15 8.34315 15 10V15C15 16.6569 13.6569 18 12 18C10.3431 18 9 16.6569 9 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <div className="relative min-h-screen bg-background text-foreground">
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-4 left-4 z-10 flex gap-2">
            <Button variant="secondary" className="rounded-full bg-accent/90 text-accent-foreground backdrop-blur-sm">
                <Music className="w-4 h-4 mr-2"/>
                Music
            </Button>
            <Button variant="secondary" className="rounded-full bg-white/90 text-foreground backdrop-blur-sm">
      ...
      <div className="relative -mt-8 rounded-t-3xl bg-background p-6">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold text-primary">{user.name}, {user.age}</h1>
          <VerifiedIcon />
        </div>
        ...
        <div className="my-6 grid grid-cols-5 items-center justify-items-center text-center text-muted-foreground text-sm gap-2">
            ...
            <div className="flex flex-col items-center gap-1">
                <Button variant="outline" size="icon" className="rounded-full border-2 w-10 h-10 shadow-md">
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-20 bg-background/80 backdrop-blur-sm p-4" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom))' }}>
        <div className="flex items-center justify-center gap-4 max-w-md mx-auto">
            <Button variant="outline" size="icon" className="h-16 w-16 rounded-full border-accent text-accent bg-accent/10 shadow-lg">
